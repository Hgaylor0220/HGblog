...
class ContentRemediationConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // 1. Fetch all Node bundles (Content Types) dynamically
    ...
    if (!empty($selected_type)) {
      ...
      foreach ($fields as $machine_name => $field) {
        // Only allow date, datetime, timestamp, or core created/changed fields
    ...
    // 3. The AJAX wrapper for the dynamic date field dropdown
