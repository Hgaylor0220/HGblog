...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  switch ($_ENV['AH_SITE_ENVIRONMENT']) {
    ...
    case 'test':
      ...
      // Use the CORRECT machine name for the key found in your drush config:get
      $config['key.key.searchstax_solr_connector_credentials']['key_provider_settings']['key_value'] = 'db56991607e26650a39ce8ff1b9e77ba6eb968f9';
      break;
  ...
  // You MUST provide a value here so the server doesn't break locally
  $config['key.key.searchstax_solr_connector_credentials']['key_provider_settings']['key_value'] = 'db56991607e26650a39ce8ff1b9e77ba6eb968f9';
}
